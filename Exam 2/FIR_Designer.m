...
defaultFxdPoint = false; %  Flag to automatically scale for fixed point numbers
...
%  If the printHeaderFlag  and FxdPoint is true then output C-header code in the command
%  window

if printHeaderFlag && fxdPointFlag
...
elseif printHeaderFlag && ~fxdPointFlag
