...
{  
  ...
  //CHEBY low, order 5, R = 1.0, 12 BPM

  const int MFILT = 6;
  static float GAIN = 1.13591e-06;
  static float b[] = {0.1000000, 0.5000000, 1.0000000, 1.0000000, 0.5000000, 0.1000000};
  static float a[] = {1.0000000, -4.8628843, 9.4795648, -9.2592853, 4.5315589, -0.8889505};
...
//  ***  Copy variable initialization code from MATLAB generator to here  ****
  ...
  a[0][0] = 1.0000000; a[0][1] =  -0.9642248; a[0][2] =  0.0000000;
  G[1] = 0.0048430;
  b[1][0] = 1.0000000; b[1][1] = 2.0015407; b[1][2]= 1.0015416;
  a[1][0] = 1.0000000; a[1][1] =  -1.9362502; a[1][2] =  0.9428418;
  G[2] = 0.0048430;
  b[2][0] = 1.0000000; b[2][1] = 1.9994122; b[2][2]= 0.9994131;
  a[2][0] = 1.0000000; a[2][1] =  -1.9624092; a[2][2] =  0.9778234;
